...
TEST_CASE("OptionalRefMonadicTest: Transform", "[optional]") {
    // lhs is empty
...
TEST_CASE("OptionalRefMonadicTest: TransformConstexpr", "[optional]") {
...
TEST_CASE("OptionalRefMonadicTest: Transform2", "[optional]") {
    // lhs is empty
    beman::optional::optional<int&> o1;
    auto                            o1r = o1.transform([](int i) { return i + 2; });
    static_assert((std::is_same<decltype(o1r), beman::optional::optional<int>>::value));
...
TEST_CASE("OptionalRefMonadicTest: TransformConstxpr", "[optional]") {
    // test each overload in turn
    constexpr beman::optional::optional<const int&> o16  = constexpr_fortytwo;
    constexpr auto                                  o16r = o16.transform(get_int);
    static_assert(*o16r == 42);
...
TEST_CASE("OptionalRefMonadicTest: and_then", "[optional]") {
    // lhs is empty
    beman::optional::optional<int&> o1;
...
TEST_CASE("OptionalRefMonadicTest: Constexpr_and_then", "[optional]") {
...
TEST_CASE("OptionalRefMonadicTest: or_else", "[optional]") {
    int                             fortytwo = 42;
    int                             thirteen = 13;
    beman::optional::optional<int&> o1       = fortytwo;
    CHECK(*(o1.or_else([&] { return beman::optional::optional<int&>(thirteen); })) == 42);

    beman::optional::optional<int&> o2;
    CHECK(13 == *(o2.or_else([&] { return beman::optional::optional<int&>(thirteen); })));
}
